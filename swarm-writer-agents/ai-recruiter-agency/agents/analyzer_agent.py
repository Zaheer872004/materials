...
class AnalyzerAgent(BaseAgent):
    def __init__(self, groq_api_key: str):
        super().__init__(
            ...
            groq_api_key=groq_api_key,  # Passing the GROQ API key
        )
    ...
    async def run(self, messages: list) -> Dict[str, Any]:
        ...
        # Get structured analysis from GROQ using the _query_groq method
        analysis_results = self._query_groq(analysis_prompt)
        ...
        return {
            ...
            "analysis_timestamp": "2024-03-14",  # You can adjust this timestamp dynamically if needed
